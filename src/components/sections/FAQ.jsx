...
const faqs = [
  {
    ...
    a: 'Out of the box: WhatsApp Business API, Instagram, Facebook Messenger, Telegram, X (Twitter), LinkedIn, and YouTube. We also offer custom integrations for SMS, web chat, email, and any platform with a public API.',
  },
  {
